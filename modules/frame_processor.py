...
class FrameProcessor:
    def __init__(self, resize_dim: Tuple[int, int] = (416, 234), frame_rate: float = 30.0, frame_skip: int = 2):
        self.resize_dim = resize_dim
        self.frameRate = frame_rate
        self.frame_rate = frame_rate
        self.resizeWidth = resize_dim[0]
        self.resizeHeight = resize_dim[1]
    ...
    def extractFrames(self, video_data):
        return self.extract_frames(video_data)
